        ...
        <div>
            ...
            <div className='grid grid-cols-2 gap-x-4 h-full'>            
                ...
                <div className=' h-full col-span-2 md:col-span-1 rounded-lg'>
                    <h2 className=' text-center text-2xl font-serif m-20 t-m-30' style={{ fontFamily: 'Roslindale'}} >Découvre notre selection de meubles pour une chambre confortable et élegante </h2>
                    <Carousel  
